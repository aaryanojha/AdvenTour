...
<body>
  ...
  <form action="../../../../Database/bookdetails.php" method="POST">
    ...
    <div id="body">
      <img src="../../../../Images/pune8.jpg" class="stretch" alt="" />
    </div>
    <div class="text">
    ...
    <div class="box2" style="font-family: 'Alata'; font-size: 22px; color: #ff571b; text-decoration: none">
      ...
      <hr style="border: 2px solid darkgrey" />
      <br>
      <b style="color:black;font-size:110%">Elpro, Pune :</b>
      ...
      <input type="hidden" name="redirectTo" value="Homepage/Pune/Destinations/Elpro/Elpro.php" />
  </form>
