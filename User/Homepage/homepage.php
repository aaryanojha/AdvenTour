...
<span class="fa fa-star checked"></span></p>
      ...
      <p>Delhi Full Tour</p>  
      <p style="font-size:2vh">Explore the sights of Old and New Delhi with your own private guide on a full-day tour. Travel in a private air-conditioned vehicle to UNESCO World Heritage sites including Jama Masjid, Qutub Minar, and Humayun's Tomb. You'll also go to other attractions like Raj Ghat—a memorial to Mahatma Gandhi, Parliament House, and Chandni Chowk; and temples such as the lavish Akshardham. Includes entrance fees, and round-trip transfers from your Delhi hotel, airport or train station. </p>
        <p style="postion:fixed">
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
...
<span class="fa fa-star"></span></p>
      ...
      <ul style="list-style-type:none;float:right;margin-top:-20vh;margin-right:10vh">
        ...
        <p style="text-align:center"> 
                ...
                <br>Powered by <a href="../../AdvenTour.php" target="_blank">AdvenTour.in</a></p>
